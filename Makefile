...
generate-images:
	...
	inkscape -f $(PWD)/assets/logo.svg -w 120 -h 120 -e $(PWD)/public/img/gitea-sm.png
	...
	inkscape -f $(PWD)/assets/logo.svg -w 32 -h 32 -e $(TMPDIR)/images/32-raw.png
	...
	cp $(TMPDIR)/images/128-raw.png $(TMPDIR)/images/128.png
	cp $(TMPDIR)/images/64-raw.png $(TMPDIR)/images/64.png
	cp $(TMPDIR)/images/32-raw.png $(TMPDIR)/images/32.png
	cp $(TMPDIR)/images/16-raw.png $(TMPDIR)/images/16.png
